...
module.exports = {
    ...
    dest: './dist',
    port: '8080',
    base: '/1805674660.github.io/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
    themeConfig: {
        // 导航配置
        nav: [
            { text: '首页', link: '/' },
        ...
        repo: '1805674660/1805674660.github.io', // 导航栏右侧生成Github链接
        ...
        author: {
            name: '1805674660', // 必需
            link: 'https://github.com/1805674660/', // 可选的
        },
        // 博主信息 (显示在首页侧边栏)
        blogger: {
        ...
        [
            'vuepress-plugin-comment', // 评论
            {
                ...
                options: {
                    ...
                    repo: '1805674660.github.io', // GitHub 仓库
                    owner: '1805674660', // GitHub仓库所有者
                    admin: ['1805674660'], // 对仓库有写权限的人
